...
class SigScan(Module):
    ...
    def run(self):
        ...
        try:
            ...
            if args.detailed:
                ...
                # If no recognized args were provided, default to basic scan
                self.do_scan()
                
        except Exception as e:
            # Catch any argument parsing errors and default to basic scan
            self.log('error', f'Error parsing arguments: {str(e)}')
            self.do_scan()  # Default to basic scan on error
    ...
    def do_scan(self, detailed=False):
        ...
        results = self._find_signatures(data, detailed=detailed)
